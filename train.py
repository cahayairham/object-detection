...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/fish-dataset.yaml', help='data.yaml path')
    ...
    parser.add_argument('--name', default='augmented_fish', help='save to project/name')
